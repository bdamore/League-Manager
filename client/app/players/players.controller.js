...
.controller('PlayersCtrl', function ($state, playerService, teamService, socket, Auth) {
...
// that.getTotal();
that.getAllTeams();
//changes players 'selected' in DB to true so that ng-hide hides it on the DOM
...
// that.unHidePlayer = function(player) {
//   playerService.unHidePlayer(player).then(function(json) {
//     that.roster = json.data;
//   });
// }
